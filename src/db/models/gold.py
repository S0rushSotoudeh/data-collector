...
class GoldInstrument(SQLModel, table=True):  # type: ignore
    ...
    isin: str | None = Field(default=None, max_length=30, index=True)
    instrument_id: str | None = Field(default=None, max_length=50, index=True)
    ...
    __table_args__ = (
        ...
        Index("idx_gold_status", "status"),
        Index("idx_gold_maturity", "maturity_date"),
    )
