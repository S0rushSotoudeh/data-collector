...
TASK_SPECS: dict[str, TaskSpec] = {
    ...
    "src.tasks.sync_gold_instruments": TaskSpec("collection", "collection.sync_gold_instruments", "gold_instruments"),
    ...
    "src.tasks.fetch_yesterday_gold_order_book": TaskSpec("collection", "collection.daily_gold_order_book", "gold_order_book"),
